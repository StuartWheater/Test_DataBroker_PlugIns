...
public class JSONLoggingDataSinkFactory implements DataFlowNodeFactory
{
    public JSONLoggingDataSinkFactory(String name, Map<String, String> properties)
    {
        _name       = name;
    ...
    {
        if (dataFlowNodeClass.isAssignableFrom(JSONLoggingDataSink.class))
            return (T) new JSONLoggingDataSink(name, properties);
        else
            return null;
    }
