...
public class JSONMongoDBDataServiceFactory implements DataFlowNodeFactory
{
    public JSONMongoDBDataServiceFactory(String name, Map<String, String> properties)
    {
        _name       = name;
    ...
    {
        if (dataFlowNodeClass.isAssignableFrom(JSONMongoDBDataService.class))
            return (T) new JSONMongoDBDataService(name, properties);
        else
            return null;
    }
